      ...
      return [
        {
          ...
          filterOptions: {
            ...
            placeholder: "Digite aluno", // placeholder for filter input
        ...
        },
        {
          ...
          filterOptions: {
            // styleClass: "class1", // class to be added to the parent th element
            enabled: true, // enable filter for this column
            placeholder: "Digite responsável", // placeholder for filter input
            // filterValue: "", // initial populated value for this filter
            // filterDropdownItems: [], // dropdown (with selected values) instead of text input
            //filterFn: this.filterFnRegiao, //custom filter function that
            // trigger: "keyup", //only trigger on enter not on keyup
        ...
        },
        {
          ...
          filterOptions: {
            // styleClass: "class1", // class to be added to the parent th element
            enabled: true, // enable filter for this column
            placeholder: "Digite email", // placeholder for filter input
            // filterValue: "", // initial populated value for this filter
            // filterDropdownItems: [], // dropdown (with selected values) instead of text input
            //filterFn: this.filterFnRegiao, //custom filter function that
            // trigger: "keyup", //only trigger on enter not on keyup
